            ...
            <div class="container" style="margin-top:80px; margin-left:150px;">
                <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9">
                                    <h2 class="panel-title">Exam Results</h2>
...
$db=new Database();
 ...
 <td> <?php echo $r['correct_answer'];  ?> </td>
 <td> <?php echo $r['wrong_answer'];  ?> </td>
 <td> <?php echo $r['exam_time'];  ?> </td>
 <td> <?php echo $r['topic'];  ?> </td>

 <td><button class="btn-danger btn"> <a href="../Operations/deleteresult.php?rid=<?php echo $r['id']; ?>&id=<?php echo $id; ?>" class="text-white"> Delete </a>  </button></td>
