                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <?php 
                                   ...
                                   {
                                echo "'<br/><br/><br/><br/><h2 class='text-success'>Inserted bulk successfuly</h2>'";
                                   }?>
                                <div style="align:center;">
                                    <h3>Bulk Data upload</h3>
                                    <form action="insert_bulk.php?id=<?php echo $id?>" enctype="multipart/form-data" method="post">
                                          <label>Import csv file :</label>
                                          <input type="file" name="csv" id="csv" class="large" style="margin-left:1020px; margin-top:-30px"/><br/>
                                         <input type="submit" name="form_submit" value="import file" style="margin-left:1020px"/>
                                    </form>
                                </div>
                                <div class="col-md-3">
